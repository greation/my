    ...
    new Vue({
        ...
        created: function () {
            ...
            if (this.userData.isLogin !== 'N') {
                if (this.userData.activityType !== 'XIAOMIGROUPNOV') {
        ...
        methods: {
            ...
            activeStatus: function () {
                ...
                $.ajax({
                    ...
                    data: {
                        activityTypeStr: 'XIAOMIGROUPNOV'
                    }
                }).done(function (data) {
            ...
            linkLogot: function () {
                $.ajax({
                    ...
                    .done(function (data) {
                        var data = JSON.parse(data);
                        if (data.code === '000') {
                            window.location.href = '/src/activity/xiaomigroupNov/index.html?random=' + parseInt(Math.random() * 100000);
                        }
                    })
            },
